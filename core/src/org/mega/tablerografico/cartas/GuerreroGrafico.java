...
public class GuerreroGrafico extends Group {
	...
	public GuerreroGrafico(Guerrero guerrero) {
		...
		Label vida = new Label(Integer.toString(guerrero.getVida()), LaFactory.skin);
		vida.setName("vida");
		vida.moveBy(3, 3);
		...
		Label nivel = new Label(Integer.toString(guerrero.getNivel()), LaFactory.skin);
		nivel.setName("nivel");
		...
		Label ataque = new Label(Integer.toString(guerrero.getAtaque()), LaFactory.skin);
